...
| 3 | MicroSims | 173 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 12 / 12 | Recommended | Chapters with a quiz.md (132 questions total) |
| 6 | Chapter References | 0 / 12 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 69 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 81 | Recommended | Questions in faq.md |
| 9 | Words | 184,464 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 101 | 101 | H4 headers starting with '#### Diagram:' |
| Equations | 859 | 726 | LaTeX expressions (inline and display) |
| Total Words | 184,464 | 109,126 | Words in markdown files |
| Links | 716 | 219 | Hyperlinks in markdown format |
| Equivalent Pages | 849 | 548 | Estimated pages (250 words/page + visuals) |
