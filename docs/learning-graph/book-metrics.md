...
| Glossary Terms | 69 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 81 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 132 | - | Questions across all chapters |
| MicroSims | 133 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
| Equations | 847 | 712 | LaTeX expressions (inline and display) |
| Total Words | 171,702 | 104,805 | Words in markdown files |
| Links | 600 | 187 | Hyperlinks in markdown format |
| Equivalent Pages | 778 | 510 | Estimated pages (250 words/page + visuals) |
