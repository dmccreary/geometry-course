...
- **Framework:** p5.js
- **Detected subjects:** Mathematics, Chemistry, Statistics, Engineering
- **Visualization types:** animation, simulation, graph, interactive-demo
- **Has main.html:** No
- **Has index.md:** Yes
