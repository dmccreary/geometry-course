---
title: Conditional Statement Structure
description: A visual diagram showing the components of conditional statements - hypothesis and conclusion.
image: /sims/conditional-statement-structure/conditional-statement-structure.png
og:image: /sims/conditional-statement-structure/conditional-statement-structure.png
twitter:image: /sims/conditional-statement-structure/conditional-statement-structure.png
social:
   cards: false
quality_score: 85
---
...
1. [Conditional Statements](https://www.khanacademy.org/math/geometry/hs-geo-foundations/hs-geo-intro-to-reasoning/v/conditional-statements) - Khan Academy
