...
**New Quiz Mode**: Test your knowledge of polygon names! Click "Quiz Mode" to receive a challenge to create a specific polygon by name. Use the sliders to create the shape, then click "Check My Answer" to see if you got it right. Get instant feedback and try as many questions as you like!
...
- **Quiz Mode Button**: Toggle quiz mode on/off
- **Check My Answer Button**: In quiz mode, check if your polygon matches the target shape (becomes "New Question" after checking)
